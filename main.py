...
try:
    ...
    try:
        ...
        clear_query = """TRUNCATE TABLE users;"""
        cursor.execute(clear_query)
        insert_query = """INSERT INTO users (login, pass, sex) VALUES 
        ...
        connection.commit()
        print("Table created successfully")
        clear_query = """TRUNCATE TABLE clients;"""
        cursor.execute(clear_query)
        insert_query = """INSERT INTO clients (login, pass, sex) VALUES 
        ...
        cursor.execute(create_query)
        connection.commit()
        clear_query = """TRUNCATE TABLE posts;"""
        cursor.execute(clear_query)
        insert_query = """INSERT INTO posts (title, full_text, user_id) VALUES 
